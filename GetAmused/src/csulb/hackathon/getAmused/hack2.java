...

{
	...
	public void init() {
		...
		System.setProperty("java.security.policy","C:/Users/Manav/Desktop/hack2/access.policy");
		...
		nameField = new TextField(
				"Is your muse headset on? If yes, wait two minutes then click on the Yes Button and enjoy the magic of Hollywood!",
				35);
		add(yes);
		add(no);
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() == yes) {
			...
			// 1. Create the frame.
			/*
			 * JFrame frame = new JFrame("Data"); JLabel label1=new
			 * JLabel(MuseOscServer.practice());
